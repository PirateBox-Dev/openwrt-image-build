...
ADDITIONAL_PACKAGE_IMAGE_URL:="http://stable.openwrt.piratebox.de/piratebox_images/piratebox_ws_2.0_img.tar.gz"
ADDITIONAL_PACKAGE_FILE:=piratebox_ws_2.0_img.tar.gz
