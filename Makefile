...
IMAGEBUILDER_URL="https://github.com/FriedZombie/OpenWrt_Attitude-Adjustment_backports/releases/download/V0.1/OpenWrt-ImageBuilder-$(ARCH)_generic-for-linux-i486.tar.bz2"
WGET=wget
